...
function returnElasticEndPoint() {
  ...
  if (!ENDPOINT) throw new Error('Elastic endpoint not found');
...
if (process.env.NODE_ENV === 'test') {
  module.exports.returnElasticEndPoint = returnElasticEndPoint;
  module.exports.generateElasticConfig = generateElasticConfig;
}
